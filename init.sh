...
mkdir -p peruskarttarasteri_jhs180/painovari
rsync -arPv tiedostot.kartat.kapsi.fi::mml/peruskarttarasteri_jhs180/painovari/ peruskarttarasteri_jhs180/painovari/
...
find peruskarttarasteri_jhs180 -iname "*.png" -print0 | xargs -0 -n100 gdaltindex peruskartta.shp

shptree peruskartta.shp
